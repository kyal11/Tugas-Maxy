    ...
    <div class="row">
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <tr>
                ...
                <th>@sortablelink('discont', __('views.admin.purchase.order.lines.index.table_header_3'),['page' =>$purchaseOrderLines->currentPage()])</th>
            ...
            @foreach($purchaseOrderLines as $purchaseOrderLine)
                <tr>
                    ...
                    <td>{{$purchaseOrderLine->discont }}</td>
