        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.reporting-page')); ?>">
                            <i class="fa fa-home" aria-hidden="true"></i>
                            <?php echo e(__('views.backend.section.navigation.menu_0_2')); ?>
            ...
            <div class="menu_section">
                <h3><?php echo e(__('views.backend.section.navigation.sub_header_4')); ?></h3>
                <ul class="nav side-menu">
                    <li>
                        <a href="<?php echo e(route('admin.products')); ?>">
                            <i class="fa fa-users" aria-hidden="true"></i>
                            <?php echo e(__('views.backend.section.navigation.menu_4_1')); ?>

                        </a>
                        <a href="<?php echo e(route('admin.purchase.order.lines')); ?>">
                            <i class="fa fa-users" aria-hidden="true"></i>
                            <?php echo e(__('views.backend.section.navigation.menu_4_2')); ?>
...
<?php /**PATH C:\Users\rizky\OneDrive\Documents\0 UPN INFORMATIKA\temp\New folder\Day9_laravel-boilerplate_Rizky Al Arief\resources\views/admin/sections/navigation.blade.php ENDPATH**/ ?>