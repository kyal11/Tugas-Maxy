    ...
    <div class="row">
        <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
            ...
            <?php $__currentLoopData = $purchaseOrderLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchaseOrderLine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($purchaseOrderLine->product->product_name); ?></td>
...
<?php echo $__env->make('admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rizky\OneDrive\Documents\0 UPN INFORMATIKA\temp\New folder\Day4_laravel-boilerplate_Rizky Al Arief\resources\views/admin/purchaseOrderLines/index.blade.php ENDPATH**/ ?>