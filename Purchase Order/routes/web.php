...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('reporting/get-product-all','DashboardController@getAllProduct')->name('reporting-all-product');
...
// Auth 2FA REGISTER
Route::post('/2fa', 'Auth\RegisterController@completeRegistration')->name('2fa')->middleware('2fa');
Route::get('/2fa', 'Auth\RegisterController@completeRegistration')->name('2fa');
...
//     $code2fa=$request->post('google2fa_code');
//     echo $code2fa;
