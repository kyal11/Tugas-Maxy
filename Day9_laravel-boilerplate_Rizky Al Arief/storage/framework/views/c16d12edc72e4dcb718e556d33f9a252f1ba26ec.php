<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                <h3><?php echo e(__('views.backend.section.navigation.sub_header_5')); ?></h3>
                <ul class="nav side-menu">
                    <li>
                        <a href="<?php echo e(route('admin.products')); ?>">
                            <i class="fa fa-users" aria-hidden="true"></i>
...
<?php /**PATH C:\Users\rizky\OneDrive\Documents\0 UPN INFORMATIKA\Maxy academy\day 3\laravel-boilerplate\resources\views/admin/sections/navigation.blade.php ENDPATH**/ ?>